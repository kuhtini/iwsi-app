package com.kuhtini.iwsi.controller;

import com.kuhtini.iwsi.domain.User;
import com.kuhtini.iwsi.repository.UserRepository;
...
public class BackendController {
    ...
    long addNewUser(@RequestParam String firstName, @RequestParam String lastName) {
        ...
        log.info(String.format("%s successfully saved into DB", user.toString()));
